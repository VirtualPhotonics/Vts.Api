...
namespace Vts.Api.Tests.Services
{
    class PlotSolutionDomainResultsServiceTests
    {
        ...
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger);
        ...
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger);
            var postData = "{\"forwardSolverType\":\"DistributedPointSourceSDA\",\"solutionDomain\":\"ROfFx\",\"independentAxes\":{\"label\":\"rho\",\"value\":0.05},\"xAxis\":{\"start\":0,\"stop\":0.5,\"count\":51},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
        ...
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger);
            var postData = "{\"forwardSolverType\":\"DistributedPointSourceSDA\",\"solutionDomain\":\"ROfRhoAndTime\",\"independentAxes\":{\"label\":\"t\",\"value\":0.05},\"xAxis\":{\"start\":0.5,\"stop\":9.5,\"count\":19},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
            var results = "{\"Id\":\"ROfRhoAndTimeFixedTime\",\"Detector\":\"R(ρ,time)\",\"XAxis\":\"ρ\",\"YAxis\":\"Reflectance\",\"Legend\":\"R(ρ,time)\",\"PlotList\":[{\"Label\":\"DistributedPointSourceSDA μa=0.01 μs'=1 t=0.05\",\"Data\":[[0.5,0.06585901221655005],[1.0,0.062455516676356737],[1.5,0.057169377087447348],[2.0,0.050511838592775582],[2.5,0.043078438756018522],[3.0,0.03546204655435764],[3.5,0.028177645294074079],[4.0,0.021611388071518672],[4.5,0.015999178653643323],[5.0,0.011432725490165871],[5.5,0.0078856759346756858],[6.0,0.0052500705229610849],[6.5,0.0033738705138895131],[7.0,0.0020928049128279666],[7.5,0.0012530434868286927],[8.0,0.0007241701219682287],[8.5,0.00040397279920643351],[9.0,0.00021752075729664121],[9.5,0.00011305410894769459]]}]}";
            Assert.AreEqual(results, data);
        }
        ...
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger);
            var postData = "{\"forwardSolverType\":\"DistributedPointSourceSDA\",\"solutionDomain\":\"ROfRhoAndFt\",\"independentAxes\":{\"label\":\"ft\",\"value\":0.05},\"xAxis\":{\"start\":0.5,\"stop\":9.5,\"count\":19},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
        ...
        public void Plot_solution_domain_roffxandft_fixed_ft()
        {
            ...
            var postData = "{\"forwardSolverType\":\"PointSourceSDA\",\"solutionDomain\":\"ROfFxAndFt\",\"independentAxes\":{\"label\":\"ft\",\"value\":0.05},\"xAxis\":{\"start\":0,\"stop\":0.5,\"count\":11},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
        ...
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger);
            var postData = "{\"forwardSolverType\":\"DistributedPointSourceSDA\",\"solutionDomain\":\"ROfFxAndFt\",\"independentAxes\":{\"label\":\"fx\",\"value\":0.05},\"xAxis\":{\"start\":0,\"stop\":0.5,\"count\":11},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
