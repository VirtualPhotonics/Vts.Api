...
namespace Vts.Api.Tests.Services
{
    class PlotSolutionDomainResultsServiceTests
    {
        ...
        public void Plot_solution_domain_rofrho()
        {
            ...
            var postData = "{\"forwardSolverType\":\"DistributedPointSourceSDA\",\"solutionDomain\":\"ROfRho\",\"xAxis\":{\"axis\":\"fx\",\"axisRange\":{\"start\":0.5,\"stop\":9.5,\"count\":19}},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
        ...
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger, new ParameterTools());
            var postData = "{\"forwardSolverType\":\"DistributedPointSourceSDA\",\"solutionDomain\":\"ROfRhoAndTime\",\"independentAxis\":{\"axis\":\"time\",\"axisValue\":0.05},\"xAxis\":{\"axis\":\"fx\",\"axisRange\":{\"start\":0.5,\"stop\":9.5,\"count\":19}},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
            var results = "{\"Id\":\"ROfRhoAndTimeFixedTime\",\"PlotList\":[{\"Label\":\"DistributedPointSourceSDA μa=0.01 μs'=1 Time=0.05\",\"Data\":[[0.5,0.06585901221655005],[1.0,0.062455516676356737],[1.5,0.057169377087447348],[2.0,0.050511838592775582],[2.5,0.043078438756018522],[3.0,0.03546204655435764],[3.5,0.028177645294074079],[4.0,0.021611388071518672],[4.5,0.015999178653643323],[5.0,0.011432725490165871],[5.5,0.0078856759346756858],[6.0,0.0052500705229610849],[6.5,0.0033738705138895131],[7.0,0.0020928049128279666],[7.5,0.0012530434868286927],[8.0,0.0007241701219682287],[8.5,0.00040397279920643351],[9.0,0.00021752075729664121],[9.5,0.00011305410894769459]]}]}";
            Assert.AreEqual(results, data);
        }
        ...
        public void Plot_solution_domain_roffxandft_fixed_ft()
        {
            ...
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
            var results = "{\"Id\":\"ROfFxAndFtFixedFt\",\"PlotList\":[{\"Label\":\"PointSourceSDA μa=0.01 μs'=1 Ft=0.05(real)\",\"Data\":[[0.0,2.4848639316800574],[0.05,2.106445955297108],[0.1,1.6823551545832978],[0.15000000000000002,1.376478415166916],[0.2,1.1529444938933089],[0.25,0.98411987619690822],[0.3,0.85281901393009019],[0.35,0.74819150993466588],[0.39999999999999997,0.66313126258618038],[0.44999999999999996,0.59281413973833241],[0.49999999999999994,0.5338595165360418]]},{\"Label\":\"PointSourceSDA μa=0.01 μs'=1 Ft=0.05(imag)\",\"Data\":[[0.0,-0.016782342167237594],[0.05,-0.006584758330568154],[0.1,-0.0027039233476860709],[0.15000000000000002,-0.0013978805916929642],[0.2,-0.00081463841701874735],[0.25,-0.00050752460955205637],[0.3,-0.00032810689361407189],[0.35,-0.00021561400849906949],[0.39999999999999997,-0.00014142147463593312],[0.44999999999999996,-9.0622166465985826E-05],[0.49999999999999994,-5.4843354150758412E-05]]}]}";
            Assert.AreEqual(results, data);
        }
        ...
        public void Plot_solution_domain_roffxandft_fixed_ft_distributedpointsourcesda()
        {
            ...
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
            var results = "{\"Id\":\"ROfFxAndFtFixedFt\",\"PlotList\":[{\"Label\":\"DistributedPointSourceSDA μa=0.01 μs'=1 Ft=0.05(real)\",\"Data\":[[0.0,2.4848639316800574],[0.05,2.106445955297108],[0.1,1.6823551545832978],[0.15000000000000002,1.376478415166916],[0.2,1.1529444938933089],[0.25,0.98411987619690822],[0.3,0.85281901393009019],[0.35,0.74819150993466588],[0.39999999999999997,0.66313126258618038],[0.44999999999999996,0.59281413973833241],[0.49999999999999994,0.5338595165360418]]},{\"Label\":\"DistributedPointSourceSDA μa=0.01 μs'=1 Ft=0.05(imag)\",\"Data\":[[0.0,-0.016782342167237594],[0.05,-0.006584758330568154],[0.1,-0.0027039233476860709],[0.15000000000000002,-0.0013978805916929642],[0.2,-0.00081463841701874735],[0.25,-0.00050752460955205637],[0.3,-0.00032810689361407189],[0.35,-0.00021561400849906949],[0.39999999999999997,-0.00014142147463593312],[0.44999999999999996,-9.0622166465985826E-05],[0.49999999999999994,-5.4843354150758412E-05]]}]}";
            Assert.AreEqual(results, data);
        }
