...
namespace Vts.Api.Tests.Services
{
    class PlotSolutionDomainResultsServiceTests
    {
        ...
        public void Plot_solution_domain_rofrho()
        {
            ...
            var postData = "{\"forwardSolverType\":\"DistributedPointSourceSDA\",\"solutionDomain\":\"ROfRho\",\"xAxis\":{\"axis\":\"rho\",\"axisRange\":{\"start\":0.5,\"stop\":9.5,\"count\":19}},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
        ...
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger, new ParameterTools());
            var postData = "{\"forwardSolverType\":\"PointSourceSDA\",\"solutionDomain\":\"ROfRho\",\"xAxis\":{\"axis\":\"wavelength\",\"axisRange\":{\"start\":650,\"stop\":1000,\"count\":8}},\"independentAxis\":{\"axis\":\"rho\",\"axisRange\":{\"start\":0.5,\"stop\":9.5,\"count\":9}},\"wavelengthOpticalPropertyList\":[{\"mua\":0.0678524459053467,\"musp\":1.06457665884717,\"g\":0.8,\"n\":1.4},{\"mua\":0.0361315970667451,\"musp\":1.02205758134735,\"g\":0.8,\"n\":1.4},{\"mua\":0.0386397078314404,\"musp\":0.984001116480081,\"g\":0.8,\"n\":1.4},{\"mua\":0.0368351407773848,\"musp\":0.949685469521921,\"g\":0.8,\"n\":1.4},{\"mua\":0.0443735471868325,\"musp\":0.918541699382405,\"g\":0.8,\"n\":1.4},{\"mua\":0.0514456486132726,\"musp\":0.890114561696066,\"g\":0.8,\"n\":1.4},{\"mua\":0.0694976128306352,\"musp\":0.864034936500061,\"g\":0.8,\"n\":1.4},{\"mua\":0.0678098107455411,\"musp\":0.84,\"g\":0.8,\"n\":1.4}],\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
            var results = "{\"Id\":\"ROfRho\",\"PlotList\":[{\"Label\":\"PointSourceSDA Rho=0.5\",\"Data\":[[650.0,0.037575594366308029],[700.0,0.00930611971108063],[750.0,0.0029739205260132136],[800.0,0.0011202344923379804],[850.0,0.00045827142014725564],[900.0,0.00019728294338474826],[950.0,8.80951583462366E-05],[1000.0,4.047385139570443E-05]]},{\"Label\":\"PointSourceSDA Rho=1.625\",\"Data\":[[650.0,1.9029153552775764E-05],[700.0,0.036425341127494307],[750.0,0.010657585196511617],[800.0,0.0039355338028903173],[850.0,0.0017114711547250518],[900.0,0.000809630138954956],[950.0,0.00040373776522230852],[1000.0,0.00020915514848908389]]},{\"Label\":\"PointSourceSDA Rho=2.75\",\"Data\":[[650.0,0.00011162789103384096],[700.0,6.1037316122173826E-05],[750.0,0.034225954428999693],[800.0,0.010286186968902721],[850.0,0.003814873671752708],[900.0,0.0016625284890804022],[950.0,0.00078755286344886878],[1000.0,0.00039285283597287584]]},{\"Label\":\"PointSourceSDA Rho=3.875\",\"Data\":[[650.0,0.00020335456137745246],[700.0,0.00010833856351438841],[750.0,5.9084853608892262E-05],[800.0,0.0324167695064711],[850.0,0.010164293733480037],[900.0,0.0038531053567852835],[950.0,0.0017127354060420855],[1000.0,0.00082730595991490849]]},{\"Label\":\"PointSourceSDA Rho=5\",\"Data\":[[650.0,0.00042060941292439553],[700.0,0.00022177830753647253],[750.0,0.000120291245952519],[800.0,6.6760821528115492E-05],[850.0,0.030497157708222037],[900.0,0.0095858760090751765],[950.0,0.0035692504470349116],[1000.0,0.0015545742016347228]]},{\"Label\":\"PointSourceSDA Rho=6.125\",\"Data\":[[650.0,0.00073517708172734033],[700.0,0.00036553410448836754],[750.0,0.0001882572984469717],[800.0,9.9619111007369024E-05],[850.0,5.3884734932340023E-05],[900.0,0.0288226994243444],[950.0,0.0090951247916137862],[1000.0,0.003336371090660979]]},{\"Label\":\"PointSourceSDA Rho=7.25\",\"Data\":[[650.0,0.001428309867090108],[700.0,0.00066356712975991917],[750.0,0.00032386465894379134],[800.0,0.00016357542248897285],[850.0,8.4807365843274108E-05],[900.0,4.4907616457900632E-05],[950.0,0.027185646168625149],[1000.0,0.00827559449445059]]},{\"Label\":\"PointSourceSDA Rho=8.375\",\"Data\":[[650.0,0.0028778505896115969],[700.0,0.0011656365810843558],[750.0,0.00051207793868213863],[800.0,0.000236113847963527],[850.0,0.00011253082080027964],[900.0,5.498748073778873E-05],[950.0,2.7412746447384668E-05],[1000.0,0.025998211719311357]]},{\"Label\":\"PointSourceSDA Rho=9.5\",\"Data\":[[650.0,0.0081901878522137352],[700.0,0.0028999195234677339],[750.0,0.0011930188488355085],[800.0,0.00053227539361280459],[850.0,0.0002492258245077268],[900.0,0.00012058878432062612],[950.0,5.9804005013378227E-05],[1000.0,3.0249618426184355E-05]]}]}";
            Assert.AreEqual(results, JsonConvert.SerializeObject(data));
        }
        ...
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger, new ParameterTools());
            var postData = "{\"forwardSolverType\":\"PointSourceSDA\",\"solutionDomain\":\"ROfRho\",\"xAxis\":{\"axis\":\"fx\",\"axisRange\":{\"start\":0.5,\"stop\":9.5,\"count\":19}},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"5\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
            var results = "{\"Id\":\"ROfRho\",\"PlotList\":[{\"Label\":\"PointSourceSDA μa=0.01 μs'=1\",\"Data\":[[0.5,0.036717565366669314],[1.0,0.022495920023422971],[1.5,0.013879262176677631],[2.0,0.00909004259895382],[2.5,0.0062645286764352335],[3.0,0.0044801714205314185],[3.5,0.0032915341287590738],[4.0,0.0024679357796148146],[4.5,0.001880333047738071],[5.0,0.0014516116956410983],[5.5,0.0011332021316975245],[6.0,0.00089323725881868422],[6.5,0.00071013402604237666],[7.0,0.00056890403099352531],[7.5,0.00045892623723661589],[8.0,0.00037254747448076136],[8.5,0.00030417414834209468],[9.0,0.00024966707466955989],[9.5,0.00020592949690778192]]}]}";
            Assert.AreNotEqual(results, JsonConvert.SerializeObject(data));
        }
        ...
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger, new ParameterTools());
            var postData = "{\"forwardSolverType\":\"DistributedPointSourceSDA\",\"solutionDomain\":\"ROfRhoAndTime\",\"xAxis\":{\"axis\":\"time\",\"axisRange\":{\"start\":0,\"stop\":0.05,\"count\":11}},\"independentAxis\":{\"axis\":\"rho\",\"axisRange\":{\"start\":0.5,\"stop\":9.5,\"count\":3}},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
        ...
        public void Plot_solution_domain_roffxandft_independent_ft_distributedpointsourcesda()
        {
            _plotSolutionDomainResultsService = new PlotSolutionDomainResultsService(_logger, new ParameterTools());
            // DistributedPointSourceSDA causes an exception for this solution domain
            var postData = "{\"forwardSolverType\":\"DistributedPointSourceSDA\",\"solutionDomain\":\"ROfFxAndFt\",\"independentAxis\":{\"axis\":\"ft\",\"axisValue\":0.05},\"xAxis\":{\"axis\":\"fx\",\"axisRange\":{\"start\":0,\"stop\":0.5,\"count\":11}},\"opticalProperties\":{\"mua\":0.01,\"musp\":1,\"g\":0.8,\"n\":1.4},\"modelAnalysis\":\"R\",\"noiseValue\":\"0\"}";
            var solutionDomainPlotParameters = JsonConvert.DeserializeObject<SolutionDomainPlotParameters>(postData);
            var data = _plotSolutionDomainResultsService.Plot(solutionDomainPlotParameters);
