...
namespace Vts.Api.Tests.Controllers
{
    ...
    {
        private IInverseSolverService _inverseSolverMock;
        [OneTimeSetUp]
        public void Setup()
        {
            // set up the mock service
            _inverseSolverMock = Substitute.For<IInverseSolverService>();
        }

        [Test]
        public void Test_controller_get()
        {
            var inverseController = new InverseController(_inverseSolverMock);
